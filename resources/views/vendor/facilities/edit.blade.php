...
<div class="facility-wrap">
    ...
    <div class="facility-card">
        ...
        <form
            method="POST"
            action="{{ route('vendor.facilities.update', $facility->id) }}"
        >
            ...
            {{-- CURRENT FACILITY --}}
            <div class="facility-current">

                <div class="facility-current-icon">

                    <i
                        class="{{ $facility->icon ?: 'fas fa-star' }}"
                    ></i>
                ...
                <div>
                    ...
                    <div class="facility-current-name">

                        {{ $facility->name }}

                    </div>

                    <div class="facility-current-type">

                        {{ ucfirst($facility->type) }} Facility
            ...
            <div class="facility-field">
                ...
                <div class="facility-help">
                    ...
                    Inactive facilities will not be available
                    for assigning to your resort or rooms.
            ...
            <div class="facility-preview">
                ...
                <span class="facility-preview-icon">

                    <i class="fas fa-info-circle"></i>

                </span>

                You can change the facility type if you need to move
                it between <strong>Resort</strong> and
                <strong>Room</strong> facilities.
