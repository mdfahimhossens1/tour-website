            ...
            <tbody id="b-tbody">
                ...
                @forelse($bookings as $i => $booking)
                    ...
                    >
                        ...
                        <td
                            style="color:var(--b-muted);font-size:.8rem;"
                        >
                            {{ $i + 1 }}
                        </td>
                        ...
                        <td>
                            ...
                            @if($booking->payment_status === 'refunded')
                                ...
                                <span class="b-badge b-badge-refunded">
                            ...
                            @elseif($booking->payment_status === 'failed')
                                ...
                                <span class="b-badge b-badge-failed">
                            ...
                            @else
                                ...
                                <span class="b-badge b-badge-cancelled">
                    ...
                    <tr>
                        ...
                        <td colspan="9">
                            ...
                            <div class="b-empty">
                                ...
                                <p>
                                    No cancelled bookings at the moment.
                                </p>
