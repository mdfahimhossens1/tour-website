...
<div class="bc-wrap">
  ...
  <div class="bc-header">
    <div>
      <div class="title"><i class="fas fa-folder-open me-2"></i>FAQ Categories</div>
      <div class="subtitle">Create and manage your FAQ category structure</div>
      ...
      <div class="bc-form-body">
        <form method="POST" action="{{ route('admin.faq.categories.store') }}">
          ...
          <div class="bc-field">
            ...
            <input type="text" name="name" placeholder="e.g. General Questions" value="{{ old('name') }}">
            ...
            <tr>
              <td colspan="5">
                <div class="bc-empty">
                  ...
                  <p>No FAQ categories yet. Create your first one!</p>
                </div>
              </td>
            </tr>
            @endforelse
  ...
  <div class="bc-modal">
    <div class="bc-modal-header">
      <div class="bc-modal-title">
        <i class="fas fa-pen" style="color:var(--p-warning);"></i> Edit FAQ Category
      </div>
...
function openEditModal(id, name, status) {
    ...
    document.getElementById('editForm').action =
        '{{ url('admin/faq-categories/update') }}/' + id;
